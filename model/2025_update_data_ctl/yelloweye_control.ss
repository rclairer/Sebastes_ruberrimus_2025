...
1926.8 #_last_yr_nobias_adj_in_MPD; begin of ramp
2014.43 #_first_yr_fullbias_adj_in_MPD; begin of plateau
2014.74 #_last_yr_fullbias_adj_in_MPD
2022.08 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
0.6487 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
