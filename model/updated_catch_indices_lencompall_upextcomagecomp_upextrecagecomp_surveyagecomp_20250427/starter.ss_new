...
#C file write time: 2025-04-27  23:53:26
yelloweye_data.ss
...
-1 # min year for sdreport outputs (-1 for styr); #_1887
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1745823470
