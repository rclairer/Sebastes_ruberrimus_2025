...
# add authors in order
  ...
  - name: 'Samantha Schiano'
    affiliations:
      - name: 'ECS Federal in support of NMFS OST'
        address: '2750 Prosperity Ave #600'
        city: 'Fairfax, VA'
        state: 'VA'
        postal-code: '22031'
...
author-note: "*These authors contributed equally to this work."
date: today
lang: en 
keep-tex: true 
...
source(here::here('Rcode/table_decision.R'))
...
Johnston, M., Rosemond, R. C., Perl, E., Whitman, A., Barros, M., Champagnat, J., Schamp, A., Schiano, S., and  Prior Caltabellotta, F. (2025) Status of Yelloweye rockfish off the U.S. West Coast in 2025. Pacific Fishery Management Council. [XX] p.
