...
#| warning: false
#| eval: true
#| fig-cap: "Comparison of the 2017 ORBS index (delta-GLM), the 2017 ORBS model (with the current dataset and implemented in sdmTMB), and the current ORBS index (sdmTMB)."
...
#
knitr::include_graphics(
    "figures/sensitivities/length_comps1compare2_spawnbio_uncertainty.png"
)
```
...
#
knitr::include_graphics(
    "figures/sensitivities/length_comps1compare4_Bratio_uncertainty.png"
)
```
...
#
knitr::include_graphics(
    "figures/sensitivities/length_comps2compare2_spawnbio_uncertainty.png"
)
```
...
#
knitr::include_graphics(
    "figures/sensitivities/length_comps2compare4_Bratio_uncertainty.png"
)
```
