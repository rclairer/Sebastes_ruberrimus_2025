...
```{r}
#| label: fig-sens_lengths_spout
#| echo: false
#| warning: false
#| eval: true
#| fig-cap: "Spawning output across length composition inclusion sensitivities."
#
knitr::include_graphics(
    "figures/sensitivities/length_compscompare2_spawnbio_uncertainty.png"
)
```

```{r}
#| label: fig-sens_lengths_status
#| echo: false
#| warning: false
#| eval: true
#| fig-cap: "Relative spawning output across length composition inclusion sensitivities."
#
knitr::include_graphics(
    "figures/sensitivities/length_compscompare4_Bratio_uncertainty.png"
)
```
