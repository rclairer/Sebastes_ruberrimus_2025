...
#| warning: false
#| eval: true
#| fig-cap: "Annual length composition data for the WCGBTS."
#
knitr::include_graphics(
...
#| warning: false
#| eval: true
#| fig-cap: "Annual unsexed conditional age-at-length data for the WCGBTS (1 of 2)."
#
knitr::include_graphics(
...
#| warning: false
#| eval: true
#| fig-cap: "Annual unsexed conditional age-at-length data for the WCGBTS (2 of 2)."
#
knitr::include_graphics(
...
#| warning: false
#| eval: true
#| fig-cap: "Fit to the log-scale WCGBTS index."
#
knitr::include_graphics(
...
```{r}
#| label: fig-bridge25-comp12
#| echo: false
#| warning: false
#| eval: true
#| fig-cap: "Time series of recruitment deviations estimated in the assessment model with ~ 95% intervals comparing the 2017 recruitment deviations in blue, to the 2025 recruitment deviations in red."
#
knitr::include_graphics(
    "figures/bridging/25_2025base_vs_2017base/compare12_recdevs_uncertainty.png"
)
```
