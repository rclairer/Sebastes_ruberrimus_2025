...
- Data: 
    ...
    - Length and age compositions from all fishery removal and index fleets were updated and tuned through 2024. The addition of composition data slightly increased the spawning output for 1920 - 1980 (@fig-bridge14-comp2). This new data also changed the pattern of the recruitment deviations from 1990 - 2024 (@fig-bridge14-comp11). From 1990 - 2005 recruitment was lower than predicted in the last assessment, then from 2006 - 2016 recruitment was higher than the last assessment, and finally recruitment dropped lower for 2017-2021. Due to the estimated recruitment in recent years, the recovery curve slowed (@fig-bridge14-comp2).
- Fleet structure:
