...
- Software and Workflow
    - Update SS3 3.30.23.1 - As seen in Figures @compare2_spawnbio_uncertainty and @compare3_Bratio, this update had no discernable impact on model results. 
...
The assessment was updated to use the most recent version of Stock Synthesis 3 (Version 3.30.23.1 - (NOTE - DOUBLE CHECK VERSION) available [online](https://github.com/nmfs-ost/ss3-source-code/releases/tag/v3.30.23.1)). Bridging between SS versions is discussed in Section @sec-changes. 
