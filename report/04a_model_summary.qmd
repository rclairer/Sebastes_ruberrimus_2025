...
- Data: 
    ...
    - Length and age compositions from all fishery removal and index fleets were updated and tuned through 2024. The addition of composition data greatly increased ln($R$~0~), which led to an increase in the spawning output, particularly for 1920-1980 **(@fig-bridge14-comp2)**. This new data also changed the patten of the recruitment deviations significantly from 1990-2024 **(@fig-bridge14-comp11)**. From 1990-2005 recruitment was lower than predicted in the last assessment, then from 2006-2016 recruitment was higher than the past, and finally recruitment dropped very low for 2017-2021. The lower estimated recruitment for recent years has slowed the recovery curve **(@fig-bridge14-comp2)**.
- Fleet structure:
...
- Selectivity and retention: 
    ...
    - All final updates in the control, starter, and forecast files showed little to no additional change in the model **(Figure XXX need to make figure that just shows change from tuned to new base)**. 
- Software and Workflow:
    ...
    - Created a public github repository for Yelloweye Rockfish ("sebastes_ruberrimus_2025") to provide a transparent and reproducible system for processing the data and creating the model and assessment document [online]https://github.com/rclairer/Sebastes_ruberrimus_2025).
