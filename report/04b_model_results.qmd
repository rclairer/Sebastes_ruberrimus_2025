...
This is the trend in biomass. See @fig-Bratio. This is the trend looking good (@fig-Bratio).

Reference to a figures that is cool (@fig-sberr).


in text ref @fig-sbratio