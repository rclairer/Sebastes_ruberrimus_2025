...
\begin{tikzpicture}[remember picture, overlay]
    ...
    at (current page.north west) {
        \includegraphics[width=8.5in, height=11in, alt={summary graphic containing images similar to figures 1, 61, and a plot showing the low, base, and hight alternative states of nature}]{figures/YEYE_at_a_glance.png}
    };
\end{tikzpicture}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Time series plot showing fishing intensity above the SPR target of 50 percent in many years from 1900 to 1975, then a steep drop below SPR 50% until 2002, and again rises above 50% from 2002 to 2024.'}]{figures/r4ss_plots/plots/SPR1_series.png}}
