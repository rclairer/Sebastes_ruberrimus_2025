...
\begin{tikzpicture}[remember picture, overlay]
    ...
    at (current page.north west) {
        \includegraphics[width=8.5in, height=11in, alt={summary graphic containing images of a stacked bar plot showing that total landings rose from the 1940s through the 1990s, decreased in the 2000s, and have since remained low, a plot comparing the spawning output trajectories for the 2017 and current base models, with little to no difference between the two time series, and a plot showing the low, base, and high alternative states of nature}]{figures/YEYE_at_a_glance.png}
    };
\end{tikzpicture}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Stacked bar plot showing total landings rose from the 1940s through the 1990s, decreased in the 2000s, and have since remained low.'}]{figures/r4ss_plots/plots/catch2_landings_stacked.png}}
...
\caption{\label{tbl-es-catches}Recent catches by fleet and total catch
(mt) summed across fleets (total catch includes WA REC catch converted
to mt).}

\centering{

\fontsize{9.0pt}{11.0pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}>{\centering\arraybackslash}p{\dimexpr 37.50pt -2\tabcolsep-1.5\arrayrulewidth}}
\toprule
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Spawning output was relatively unfished prior to the 1940s, decreased to the lowest point in the early 2000s, and then increased to the end of the time series.'}]{figures/r4ss_plots/plots/ts7_Spawning_output_with_95_intervals.png}}

}

\caption{\label{fig-es-so}Time series of estimated spawning output
(billions of eggs) for the base model (circles) with \textasciitilde{}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'The estimated fraction unfished was relatively unfished between the start of the model through the 1940s, decreased to the lowest point in the early 2000s below management targets, and then increased to the end of the time series.'}]{figures/r4ss_plots/plots/ts9_Relative_spawning_output_intervals.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'The estimated fraction unfished for both model areas was relatively unfished between the start of the model through the 1940s, decreased to the lowest point in the early 2000s below management targets, and then increased to the end of the time series.'}]{figures/r4ss_plots/plots/ts10_Relative_spawning_output.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of recruits and uncertainty intervals over time showing increasing recruitment in the early 1980s and 2010s.'}]{figures/r4ss_plots/plots/ts11_Age-0_recruits_(1000s)_with_95_asymptotic_intervals.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of recruitment deviations and uncertainty intervals over time showing increasing recruitment in the early 1980s and 2010s and decreasing recruitment in the 1990s and more recent years.'}]{figures/r4ss_plots/plots/recdevs2_withbars.png}}
...
and slightly above the management target SO\textsubscript{40\%} of
unfished spawning output. Fishing intensity increased throughout the
1900s as the stock was fished down, until stabilizing at peak intensity
between the mid-1980s and late 1990s and substantially decreasing in the
late 1990s and early 2000s, around the time the stock was declared
overfished. Fishing intensity has since been relatively stable
(Figure~\ref{fig-es-kobe}, Table~\ref{tbl-es-spr}).

\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio,alt={'Phase plot showing population trajectory. Tabular information is available for the values of the fraction unfished and fishing intensity which are related in this figure'}]{figures/r4ss_plots/plots/SPR4_phase.png}}
...
(`Spawn', in billions of eggs) and Fraction of unfished spawning output
...
due to small sample sizes. Years that were excluded due to small sample
sizes include 2003, 2016, and 2019. The final filtered data set included
6,839 trips with a 6.1\% encounter rate for Yelloweye Rockfish
...
(Figure~\ref{fig-ORFS_comp}). For the two years that differed
significantly, 2001 was a pilot study year and 2013 had high variance.
The 2017 assessment stated that the previous modeling approach struggled
with convergence, whereas this \gls{sdmtmb} model from 2024 has multiple
checks and passed all internal package diagnostics. Thus, the updated
index has reduced within-year variance and a lack of extreme swings in
the standardized index value relative to the index from 2017.
...
\item
  ...
  \item
    ...
    composition data slightly increased the spawning output for 1920 -
    1980 (Figure~\ref{fig-bridge14-comp2}). This new data also changed
    the pattern of the recruitment deviations from 1990 - 2024
    (Figure~\ref{fig-bridge14-comp11}). From 1990 - 2005 recruitment was
    lower than predicted in the last assessment, then from 2006 - 2016
    recruitment was higher than the last assessment, and finally
    recruitment dropped lower for 2017-2021. Due to the estimated
    recruitment in recent years, the recovery curve slowed
...
(Figure~\ref{fig-tsrecuits}). From 1900 to 2006, the 2025 base model
recruitment deviations closely track the 2017 model recruitment
deviations, without any significant differences
(Figure~\ref{fig-bridge25-comp12}). From 2007 to 2016 we begin to see an
increase in 2025 model recruitment deviations and a departure from lower
2017 model recruitment deviations due to composition data now being
available to inform year class strength for that time period. This
extended recent period of higher recruitment is likely driving the
overall estimated population increase. Recruitment deviations for 2017
to 2024 are based on the assumed shape of the spawner-recruit curve for
years without compositional data to inform year class strength.
...
allocation decisions (Figure~\ref{fig-status_area}).
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Tabular information for this figure can be found in the data file.'}]{figures/r4ss_plots/plots/data_plot.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Diagnostic quantile-quantile plot showing residuals followed a normal distribution for the sdmTMB model fit for the Oregon Onboard Observer (ORFS) index.'}]{figures/indices/ORFS_qq.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot comparing the estimated Oregon Onboard Observer index used in the 2017 and current assessments, showing that the general trend is the same with some year-to-year differences.'}]{figures/indices/ORFS index comparison_errbars.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Diagnostic quantile-quantile plot showing residuals followed a normal distribution for the updated portion of the Oregon recreational (ORBS) index.'}]{figures/indices/ORBS_qq.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot showing the estimated yearly index and uncertainty for the Oregon Recreational index, showing the difference in scale between the two sampling periods.'}]{figures/r4ss_plots/plots/index4_logcpuedata_6_OR_REC.png}}

}

\caption{\label{fig-ORBS_index}Annual relative log-scale index of
abundance for the Oregon recreational index, including both MRFSS (1980
- 1999) and ORBS (2004 - 2024) indices.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot comparing the estimated Oregon recreational index used in the 2017 assessment estimated with a delta-GLM versus estimated with sdmTMB and the index with a modified structure also estimated with sdmTMB. The largest difference in the point estimates is between the model type used.'}]{figures/indices/ORBS index comparison_ORBSonly_errbars.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Diagnostic quantile-quantile plot showing residuals followed a normal distribution for the West Coast Groundfish Bottom Trawl Survey (WCGBTS) index.'}]{figures/indices/wcgbts_qq.png}}
...
\includegraphics[width=1.2\linewidth,height=\textheight,keepaspectratio,alt={'Plot comparing the estimated West Coast Groundfish Bottom Trawl Survey index used in the 2017 and current assessments, showing that the general trend is the same with some year-to-year differences.'}]{figures/indices/wcgbts_index_comparison.png}

}

\caption{\label{fig-wcgbtsindexcomparison}Comparison of the 2017 West
Coast Groundfish Bottom Trawl Survey (WCGBTS) and the current WCGBTS
index of abundance.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot comparing the estimated International Pacific Halibut Commission survey index used in the 2017 and current assessments, showing that the general trend is the same with some year-to-year differences.'}]{figures/indices/IPHC_index_comparison.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Multi-panel plot showing yearly length composition data for the West Coast Groundfish Bottom Trawl Survey.'}]{figures/r4ss_plots/plots/comp_lendat_flt11mkt0.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Multi-panel plot showing yearly length composition data for the International Pacific Halibut Commission longline survey.'}]{figures/r4ss_plots/plots/comp_lendat_flt12mkt0.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Muli-panel plot showing yearly age-at-length compositions for the West Coast Groundfish Bottom Trawl Survey (1 of 2).'}]{figures/r4ss_plots/plots/comp_condAALdat_bubflt11mkt0_page1.png}}

}

\caption{\label{fig-NWFSC_agecomps1}Annual unsexed conditional
age-at-length data for the WCGBTS (1 of 2).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Muli-panel plot showing yearly age-at-length compositions for the West Coast Groundfish Bottom Trawl Survey (2 of 2).'}]{figures/r4ss_plots/plots/comp_condAALdat_bubflt11mkt0_page2.png}}

}

\caption{\label{fig-NWFSC_agecomps2}Annual unsexed conditional
age-at-length data for the WCGBTS (2 of 2).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Muli-panel plot showing yearly age-at-length compositions for the International Pacific Halibut Commission survey (1 of 2).'}]{figures/r4ss_plots/plots/comp_condAALdat_bubflt12mkt0_page1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Muli-panel plot showing yearly age-at-length compositions for the International Pacific Halibut Commission survey (2 of 2).'}]{figures/r4ss_plots/plots/comp_condAALdat_bubflt12mkt0_page2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of the estimated length-weight relationship for Yelloweye Rockfish, showing an exponential increase of weight at length.'}]{figures/r4ss_plots/plots/bio5_weightatsize.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of the estimated functional maturity at length relationship for Yelloweye Rockfish.'}]{figures/r4ss_plots/plots/bio6_maturity.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of the estimated fecundity at length relationship for Yelloweye Rockfish, , showing an exponential increase of fecunity at length..'}]{figures/r4ss_plots/plots/bio9_fecundity_len.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory of the spawning output from the 2017 model does not change after updating and extending historical catch.'}]{figures/bridging/3_extendedcatch/compare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-bridge3-comp2}Comparison of the spawning output
(billions of eggs) of the 2017 model with an updated SS3 executable
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory of the spawning output relative to unfished from the 2017 model does not change after updating and extending historical catch.'}]{figures/bridging/3_extendedcatch/compare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory of the adult Yelloweye Rockfish biomass from the 2017 model does not change after updating and extending historical catch.'}]{figures/bridging/3_extendedcatch/compare18_smrybio.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory of the spawning output is simliar with updated and extended catch and indicies, but, in the current model the scale increased slightly in the historical period and decreased slightly in the contemporary period.'}]{figures/bridging/5_newindices/compare2_spawnbio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory of the spawning output is simliar with updated and extended catch, indicies, and compositional data.'}]{figures/bridging/14_tunecomps/compare2_spawnbio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing minor differences in recruitment deviations with the additional of contemporary catch and compositional data and indices.'}]{figures/bridging/14_tunecomps/compare11_recdevs.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory of the spawning output is simliar with updated and extended data, tuning, and final model adjustments, but the scale increased slightly in the current model.'}]{figures/bridging/23_alldata_tunecomps_fitbias_upctl_tuned_upstart_refine_fore/compare2_spawnbio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory of the spawning output relative to unfished is simliar with updated and extended data, tuning, and final model adjustments, but the scale increased slightly in the current model.'}]{figures/bridging/23_alldata_tunecomps_fitbias_upctl_tuned_upstart_refine_fore/compare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure showing that the trajectory from the 2017 assessment is similar when using the newest version of stock synthesis.'}]{figures/bridging/1_SS3exe/compare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Growth curve asymptotes around age 40. See parameter table for growth parameters.'}]{figures/r4ss_plots/plots/bio1_sizeatage.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Time series plot showing a period of higher variance (low transformed variance) through the 1940s, followed by a informed recruitment deviations. The bias adjustment used in the model is as recommended.'}]{figures/r4ss_plots/plots/recruit_fit_bias_adjust.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Asymptotic selectivity is estimated for all fleets.'}]{figures/r4ss_plots/plots/sel01_multiple_fleets_length1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of estimated spawning output at length, showing an exponential increase of spawning output at length after 40 cm.'}]{figures/r4ss_plots/plots/bio10_spawningoutput_len.png}}

}

\caption{\label{fig-spoutlen}Spawning output (billions of eggs) at
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of estimated recuitments by year, with the fitted stock-recruitment curve before and after bias adjustment.'}]{figures/r4ss_plots/plots/SR_curve.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the California MRFSS recreational index of abundance, showing the model fit falls within the bounds of uncertainty except for one year.'}]{figures/r4ss_plots/plots/index5_logcpuefit_3_CA_REC.png}}

}

\caption{\label{fig-indexfit3}Fit to the log-scale California MRFSS
recreational index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the Oregon recreational index of abundance, showing the model fit falls within the bounds of uncertainty except for most years and includes and offset between two sampling periods.'}]{figures/r4ss_plots/plots/index5_logcpuefit_6_OR_REC.png}}

}

\caption{\label{fig-indexfit6}Fit to the log-scale Oregon recreational
index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the Washington recreational index of abundance, showing the model fit falls within the bounds of uncertainty except for one year.'}]{figures/r4ss_plots/plots/index5_logcpuefit_7_WA_REC.png}}

}

\caption{\label{fig-indexfit7}Fit to the log-scale Washington
recreational index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the California CPFV observer index of abundance, showing the model fit falls within the bounds of uncertainty.'}]{figures/r4ss_plots/plots/index5_logcpuefit_8_CACPFV.png}}

}

\caption{\label{fig-indexfit8}Fit to the log-scale California CPFV
observer index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the Oregon onboard observer index of abundance, showing the model fit falls within the bounds of uncertainty. The index values increase slightly over time.'}]{figures/r4ss_plots/plots/index5_logcpuefit_9_OR_RECOB.png}}

}

\caption{\label{fig-indexfit9}Fit to the log-scale Oregon onboard
observer (ORFS) index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the Triennial survey index of abundance, howing the model fit falls within the bounds of uncertainty.'}]{figures/r4ss_plots/plots/index5_logcpuefit_10_TRI_ORWA.png}}

}

\caption{\label{fig-indexfit10}Fit to the log-scale Triennial survey
index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the WCGBTS survey index. The model fit generally well to the index. The index values increase slightly over time. Data was missing for 2020.'}]{figures/r4ss_plots/plots/index5_logcpuefit_11_NWFSC_ORWA.png}}

}

\caption{\label{fig-indexfit11}Fit to the log-scale WCGBTS index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Model fit to the IPHC survey index. The model fit generally well to the index and is consistant across all  years, however, the model fit does not caputure yearly varriation well.'}]{figures/r4ss_plots/plots/index5_logcpuefit_12_IPHC_ORWA.png}}

}

\caption{\label{fig-indexfit12}Fit to the log-scale IPHC survey index.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'A 3 by 4 plot panel showing model fits to the length compostion data aggregated across time and separated by fleet. Length (cm) is on the x-axis, and proportion is on the y-axis. The greyed area under the curve is the length data, and the green line is the model estimates, which fit the data reasonably well.'}]{figures/r4ss_plots/plots/comp_lenfit__aggregated_across_time.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'There are no clear patters in the residuals in the observed fits.'}]{figures/r4ss_plots/plots/comp_lenfit__page1_multi-fleet_comparison.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'There are no clear patters in the residuals in the observed fits.'}]{figures/r4ss_plots/plots/comp_lenfit__page2_multi-fleet_comparison.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Mean age for the conditional age-at-length California nontrawl fleet is available from 1978 to 1988, and in 2005. Mean age varried widely from 5 to 25 years old. Limited years of data were available.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge2_CA_NONTWL.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'The California recreational fleet had very sporatic conditional ages avialable, some were available for the early 1980s, 1995, and early 2010's. Overall, mean age ranged from 10-50 years old. Limited years of data were available.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge3_CA_REC.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Mean age for the conditional age-at-length Oregon/Wasington trawl fleet is available from 2000 to 2024. Mean age varried widely from 2000 to 2011 around 5 to 40 years old. Then, from 2012 to 2024, mean age varried closer to 10-20 years old with less variance.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge4_ORWA_TWL.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Mean age for the conditional age-at-length Oregon/Wasington nontrawl fleet is available from 2001 to 2024. Mean age varried consistently around 25 years old, but with wide error bars around 2011, 2014, and 2020. Also, data was missing for 2016.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge5_ORWA_NONTWL.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Mean age for the conditional age-at-length Oregon/Wasington recreational fleet is available from 1980 to 2016, with very sparce data from 1980 to 2009. Mean age before 2009 ranged from 15-30 years. From 2009-2016 mean age varried from 5 to 25, with very wide error bars.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge6_OR_REC.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Mean age for the conditional age-at-length Wasington recreational fleet is available from 1998 to 2024, with few years of missing data. Mean age varries between 10 and 35 years old. In 2010, mean age jumps to around 50 years old with high varriance.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge7_WA_REC.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Mean age for the conditional age-at-length WCGBTS survey is available from 2003 to 2024, with data missing in 2020. Mean age varries between 20 and 25 years old until 2015, where the mean age drops to 15-20.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge11_NWFSC_ORWA.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Mean age for the conditional age-at-length IPHC survey is available from 2001 to 2024, with data missing in 2020 and 2021. Mean age varries between 30 and 40 years old. However, the model expectation line consistently under estimates mean age across years, potentially due to high varriance in 2016 data.'}]{figures/r4ss_plots/plots/comp_condAALfit_data_weighting_TA1-8_condAge12_IPHC_ORWA.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'The combined area spawning output is relatively unfished between the start of the model until the mid 1950s with spawnign output sharply decreasing to low levels by 2000 remaining low until the early 2000s where spawning output begins to increase and reaches the management target of 0.40 by 2024.'}]{figures/r4ss_plots/plots/ts7_Spawning_output_with_95_intervals.png}}

}

\caption{\label{fig-spout_combined}Estimated spawning output (billions
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Spawning output is relatively unfished between the start of the model until the mid 1950s with spawning output sharply decreasing to low levels by 2000 remaining low until the early 2000s where the spawnig output begins to increase and reaches the management target of 0.40 by 2024. The two areas generally follow the same trend, with Area 1 (California) consistently having a much lower spawning output compared to Area 2 (Oregon and Washington)'}]{figures/r4ss_plots/plots/ts8_Spawning_output_by_area.png}}

}

\caption{\label{fig-spout_area}Estimated spawning output (billions of
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'The combined area stock status is relatively unfished between the start of the model until the mid 1950s with the stock sharply decreasing to low levels by 2000 remaining low until the early 2000s where the stock begins to increase and reaches the management target of 0.40 by 2024.'}]{figures/r4ss_plots/plots/ts9_Relative_spawning_output_intervals.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Stock status is relatively unfished between the start of the model until the mid 1950s with the stock sharply decreasing to low levels by 2000 remaining low until the early 2000s where the stock begins to increase and reaches the management target of 0.40 by 2024. The two areas generally follow the same trend, with Area 1 (California) consistently having a much lower relative stock status compared to Area 2 (Oregon and Washington)'}]{figures/r4ss_plots/plots/ts10_Relative_spawning_output.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Total biomass in metric tons by area is relatively unfished between the start of the model through 1950 with the biomass sharply decreasing to low levels by the mid 1990s remaining low, increasing in the early 2000s and to the end of the time series. The two areas generally follow the same trend, with Area 1 (California) consistently having a much lower biomass compared to Area 2 (Oregon and Washington).'}]{figures/r4ss_plots/plots/ts2_Total_biomass_(t)_by_area.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Summary biomass in metric tons by area is relatively unfished between the start of the model through 1950 with the biomass sharply decreasing to low levels by the mid 1990s remaining low, increasing in the early 2000s and to the end of the time series. The two areas generally follow the same trend, with Area 1 (California) consistently having a much lower summary biomass compared to Area 2 (Oregon and Washington).'}]{figures/r4ss_plots/plots/ts5_Summary_biomass_(t)_by_area.png}}

}

\caption{\label{fig-summbio}Summary biomass (t) of age 8+ fish over time
and by area (Area 1 is California, Area 2 is Oregon/Washington
combined).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure shows the total Age-0 recruites for the current base model. Recruitment generally peaked in the 1950s, 1970s, 1980s, and 2010s.'}]{figures/r4ss_plots/plots/ts11_Age-0_recruits_(1000s)_with_95_asymptotic_intervals.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing the fraction of unfished biomass trajectories for the 2017 and current base models. There is little to no difference between the two time series, and the time series from the current model seems to continue on the same general path that 2017 ended.'}]{figures/bridging/25_2025base_vs_2017base/compare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure compares the recriutment deviations between the 2017 assessment model and current base model. Recruitment generally peaked in the 1950s, 1970s, 1980s, and 2010s. The recent period (2010-2024) showed higher recriutment in the current model compared to the 2017 model.'}]{figures/bridging/25_2025base_vs_2017base/compare12_recdevs_uncertainty.png}}

}

\caption{\label{fig-bridge25-comp12}Time series of recruitment
deviations estimated in the assessment model with \textasciitilde{} 95\%
intervals comparing the 2017 recruitment deviations in blue, to the 2025
recruitment deviations in red.}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'A jitter point plot showing the change in negative log-likelihood of 100 iterations. The majority of iterations fell in line with the base model likelihood (green dots), some (the blue dots) had higher likelihood, but none had a lower likelihood.'}]{figures/diagnostics/2025_base_model_jitter_0.1/jitter.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing spawning output between sensitivity models and the base model when estimating natural mortality, steepness, and using the 2017 length-weight relationship. There is a significant increase in spawning output when the model estimates either natural mortality or steepness.'}]{figures/sensitivities/modelingcompare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-sens_model_spout}Spawning output (billions of eggs)
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing fraction of unfished biomass between sensitivity models and the base model when estimating natural mortality, steepness, and using the 2017 length-weight relationship. There is a significant increase in stock status when the model estimates either natural mortality or steepness.'}]{figures/sensitivities/modelingcompare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing spawning output between sensitivity models and the base model, and showing few changes as length data are excluded.'}]{figures/sensitivities/length_comps_1compare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-sens_lengths1_spout}Spawning output (billions of
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing spawnig output between sensitivity models and the base model, and showing no changes as length data are excluded. Except, when removing all length data, the spawning output nearly doubles.'}]{figures/sensitivities/length_comps_2compare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-sens_lengths2_spout}Spawning output (billions of
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing fraction of unfished biomass between sensitivity models and the base model, and showing no changes as length data are excluded.'}]{figures/sensitivities/length_comps_1compare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing fraction of unfished biomass between sensitivity models and the base model, and showing no changes as length data are excluded. Except, when removing all length data, the status greatly increases.'}]{figures/sensitivities/length_comps_2compare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing spawning output between sensitivity models and the base model, and showing few changes as more age data are excluded.'}]{figures/sensitivities/age_comps_1compare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-sens_age1_spout}Spawning output (billions of eggs)
across age composition inclusion sensitivities (1 of 2).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing spawning output between sensitivity models and the base model, and showing few changes as more age data are excluded. Removing the IPHC age data slightly reduced spawning output, whereas using the McAllister and Ianelli weighting increased the spawning output.'}]{figures/sensitivities/age_comps_2compare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-sens_age2_spout}Spawning output (billions of eggs)
across age composition inclusion sensitivities (2 of 2).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing fraction of unfished biomass between sensitivity models and the base model, and showing few changes as more age data are excluded.'}]{figures/sensitivities/age_comps_1compare4_Bratio_uncertainty.png}}

}

\caption{\label{fig-sens_age1_status}Relative spawning output across age
composition inclusion sensitivities (1 of 2).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing fraction of unfished biomass between sensitivity models and the base model, and showing few changes as more age data are excluded. Removing the IPHC age data slightly reduced overall fraction unfished, whereas using the McAllister and Ianelli weighting increased the fraction of unfished biomass.'}]{figures/sensitivities/age_comps_2compare4_Bratio_uncertainty.png}}

}

\caption{\label{fig-sens_age2_status}Relative spawning output across age
composition inclusion sensitivities (2 of 2).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing spawning output between sensitivity models and the base model, and showing relatively little changes when removing indices with the exception of excluding all indices and the IPHC index.'}]{figures/sensitivities/indicescompare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-sens_indices_spout}Spawning output (billions of
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Figure comparing fraction of unfished biomass between sensitivity models and the base model, and showing relatively little changes when removing indices with the exception of excluding all indices and the IPHC index.'}]{figures/sensitivities/indicescompare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'A summary of the relative changes in management quantities from all sensitivity models with relative change on the x-axis and each data source removed on the y-axis. Plot highlights that the model is most sensitive to removing all length composition data.'}]{figures/sensitivities/sens_summary.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'A summary of the relative changes in management quantities from all sensitivity models, except the removal of all length compostion data with relative change on the x-axis and each data source removed on the y-axis. Plot highlights that besides removing all length composition data, the model is most sensitive to estimating steepness and natural mortality.'}]{figures/sensitivities/sens_summary_with_no_length_comps.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of spawning output with uncertainty intervals over time. As years of data are removed there is no change to overall spawning output.'}]{figures/diagnostics/2025_base_model_retro_5_yr_peel/compare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-retro-sp-output}Results of retrospective analysis.
Spawning output (billions of eggs) time series of this assesment base
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of relative biomass with uncertainty intervals over time. As years of data are removed there is no change to overall fraction of unfished biomass.'}]{figures/diagnostics/2025_base_model_retro_5_yr_peel/compare4_Bratio_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Plot of recruitment deviations with uncertainty intervals over time. As years of data are removed there is little change to overall recuritment deviations.'}]{figures/diagnostics/2025_base_model_retro_5_yr_peel/compare12_recdevs_uncertainty.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Time series line plot with years on the x-axis and relative depletion on the y-axis.  Each line shows the change in the base model from the 2001 assessment to the current assessment. Overtime models have remained relatively consistent'}]{figures/bridging/Timeseries_comp_previous_assessments.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Four panel plot with natural mortality values on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model. The recruitment, recreational length data, and survey indices are the primarily source of information informing the estimate of natural mortality. There is little information about natural mortality from the age data.'}]{figures/diagnostics/2025_base_model_profile_NatM_break_1_Fem_GP_1/piner_panel_NatM_break_1_Fem_GP_1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Time series line plot with year on the x-axis and fraction unfished on the y-axis. The lines represent multiple model runs that assume a range of natural mortality values from 0.030 to 0.060. Any model with a natural mortality less than 0.044 has the fraction of unfished biomass fall below the management target of 0.40.'}]{figures/diagnostics/2025_base_model_profile_NatM_break_1_Fem_GP_1/NatM_break_1_Fem_GP_1_trajectories_compare3_Bratio.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Four panel plot with steepness values on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model. The recruitment and length data are the primarily sources of information informing the estimate of steepness. There is some information about steepness from the survey indices, but little from the age data.'}]{figures/diagnostics/2025_base_model_profile_SR_BH_steep/piner_panel_SR_BH_steep.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Time series line plot with year on the x-axis and fraction unfished on the y-axis. The lines represent  multiple model runs that assume a range of steepness values from 0.25 to  1.00. Any model with a steepness less than 0.7 has the fraction of unfished biomass fall below the management target of 0.40.'}]{figures/diagnostics/2025_base_model_profile_SR_BH_steep/SR_BH_steep_trajectories_compare3_Bratio.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Four panel plot with ln(R0) on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model. The recruitment data is the primarily source of information informing the estimate of log(R0) with index data  supporting higher log(R0). There is little information about log(R0) from the length and age compostion data.'}]{figures/diagnostics/2025_base_model_profile_SR_LN(R0)/piner_panel_SR_LN(R0).png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Time series line plot with year on the x-axis and spawning output on the y-axis. The lines represent  multiple model runs that assume a range of ln(R0) values from 5.0 to 6.0. The lines are stacked with ln(R0) values of 6.0 with the highest spawning output, and ln(R0) of 5.0 with the lowest spawning output.'}]{figures/diagnostics/2025_base_model_profile_SR_LN(R0)/SR_LN(R0)_trajectories_compare1_spawnbio.png}}

}

\caption{\label{fig-rzero-sp-output}Spawning output (billions of eggs)
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Four panel plot with ln(R0) on the x-axis and values on the y-axis as described in the caption. The likelihood figure reflects a bowl, with the minimum at the estimate of ln(R0). In the other panels, as ln(R0) increases, the spawning output relative to unfished, initial spawning output, and final spawning output all increase as well.'}]{figures/diagnostics/2025_base_model_profile_SR_LN(R0)/parameter_panel_SR_LN(R0).png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Time series plot showing fishing intensity above the SPR target of 50 percent in many years from 1900 to 1975, then a steep drop below SPR 50 percent until 2002, and again rises above 50 percent from 2002 to 2024.'}]{figures/r4ss_plots/plots/SPR1_series.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Yield curve shows equilibrium yield as a domed function of fraction of unfished spawning output, with a peak slightly below 0.3, a maximum sustainable yield around 120t, and a biomass target at 0.4.'}]{figures/r4ss_plots/plots/yield1_yield_curve.png}}
