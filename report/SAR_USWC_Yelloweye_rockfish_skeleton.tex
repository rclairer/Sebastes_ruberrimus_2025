...
1,117.6-1,262.4 million eggs) (Figure~\ref{fig-es-so}). At the beginning
of 2025, the spawning stock output is estimated to be 477.63 million
eggs (95\% confidence interval: 384--571 million eggs), which represents
...
above the management target SB40\% of unfished spawning biomass. Fishing
...
confidence interval: 1,117.6-1,262.4 million eggs). The management
target for Yelloweye Rockfish is defined as 40\% of the unfished
spawning output (SB40\%), which is estimated by the model to be 476
million eggs (95\% confidence interval: 447-505), which corresponds to
an exploitation rate of 0.026. This harvest rate provides an equilibrium
yield of 128 mt at SB40\% (95\% confidence interval: 120-136 mt). The
...
estimate was converted from 3.22 metric tons to 1.53 based on a mean
weight of 2.105 kg estimated by SS3 for this fleet in 2024. The
alternative states of nature (`Low', `Base', and `High' as discussed in
the text) are provided in the columns, with Spawning Output (`Spawn', in
millions of eggs) and Fraction of unfished spawning output (`Frac')
...
Unfished recruitment was estimated at 5 thousands of fish. The von
...
recreational fleet and the IPHC survey, where the model predicts a lower
mean age than the data suggest but these results are consistent with the
2017 assessment. Pearson residuals by year and fleet show strong
residual patterns but are difficult to interpret given the general lack
of age data. See the
...
continental U.S. Pacific Coast is currently at 40.1\% of its unexploited
level. This is above the overfished threshold of SB25\%, and slightly
above the management target of SB40\% of unfished spawning biomass. Both
...
Yelloweye Rockfish was estimated to be 1190 million eggs (95\%
confidence interval: \textbf{1,045.7-1,328.5} million eggs). The stock
is declared overfished if the current spawning output is estimated to be
below the \gls{msst} of 25\% of unfished level (SB25\%). The management
target for Yelloweye Rockfish is defined as 40\% of the unfished
spawning output (SB40\%), which is estimated by the model to be
\textbf{475} million eggs (95\% confidence interval: \textbf{418-531}
million eggs), which corresponds to an exploitation rate of
\textbf{0.026}. This harvest rate provides an equilibrium yield of
\textbf{121} mt at SB40\% (95\% confidence interval: \textbf{107-136}
mt). The model estimate of maximum sustainable yield (MSY) is
\textbf{127} mt (95\% confidence interval: \textbf{112-142} mt). The
estimated spawning stock output at MSY is \textbf{344} million eggs
(95\% confidence interval: \textbf{303-384} million eggs). The
exploitation rate corresponding to the estimated SPRMSY of F36\% is
\textbf{0.036}.
...
\midrule\addlinespace[2.5pt]
1889 & 0.000000 & 0.00000 & 0.000 & 0.000000 & 0.0400 & 0.00 & 0 & 0.000 & 0.040 \\ 
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/r4ss_plots/plots/index1_cpuedata_9_OR_RECOB.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/r4ss_plots/plots/index1_cpuedata_6_OR_REC.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/indices/wcgbts_index_comparison.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/r4ss_plots/plots/index1_cpuedata_11_NWFSC_ORWA.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/r4ss_plots/plots/index1_cpuedata_12_IPHC_ORWA.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/bridging/19_base_comm_discards_updated/compare2_spawnbio_uncertainty.png}}

}

\caption{\label{fig-bridge19-comp2}Comparison of the spawning output
(millions of eggs) of the 2017 model with an updated SS3 executable
(blue), updated and extended and tuned data (red), and the proposed 2025
base model after all final bridging steps (green).}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/bridging/19_base_comm_discards_updated/compare4_Bratio_uncertainty.png}}
