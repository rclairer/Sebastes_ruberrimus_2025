...
\begin{tikzpicture}[remember picture, overlay]
    ...
    at (current page.north west) {
        \includegraphics[width=8.5in, height=11in, alt={summary graphic containing images similar to figures XX, XX, and XX and table XX}]{figures/YEYE_at_a_glance.png}
    };
\end{tikzpicture}
