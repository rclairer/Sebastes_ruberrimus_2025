...
is shown in \textbf{?@fig-ORFS\_index}. A comparison to the ORFS index
...
ODFW no longer maintains the deltaGLM code that was used to develop the
2017 index and so the index was updated to use the currently accepted
...
areas (California and Oregon-Washington) are above the overfished level
of 25\%. The assessment estimates that the coastwide spawning output of
Yelloweye Rockfish dropped below the SO40\% target for the first time in
1986 and below the overfished SO25\% threshold in 1993, as a result of
...
an equilibrium yield of 122 mt at SO40\% (95\% confidence interval: 108
- 137 mt). The model estimate of maximum sustainable yield (MSY) is 128
mt (95\% confidence interval: 113 - 143 mt). The estimated spawning
...
Hamel prior (0.044 y-1), estimated using the maximum age of 123 years.
The natural mortality value for the high state of nature was calculated
to correspond to 97 years of age, which was the 99th percentile of the
age data available for the 2017 assessment (Gertseva and Cope (2017));
this value was 0.056 y-1. The natural mortality value for low state of
nature was calculated to correspond to 147 years of age, which is the
maximum age reported for the Yelloweye Rockfish at the time of the 2017
assessment (Gertseva and Cope (2017)); this value was 0.037 y-1.
...
\includegraphics{figures/r4ss_plots/plots/index4_logcpuedata_6_OR_REC.png}
...
\includegraphics{figures/sensitivities/age_comps_1compare2_spawnbio_uncertainty.png}

}

\caption{\label{fig-sens_age1_spout}Spawning output (millions of eggs)
...
\includegraphics{figures/sensitivities/age_comps_2compare2_spawnbio_uncertainty.png}

}

\caption{\label{fig-sens_age2_spout}Spawning output (millions of eggs)
...
\includegraphics{figures/sensitivities/age_comps_1compare4_Bratio_uncertainty.png}
...
\includegraphics{figures/sensitivities/age_comps_2compare4_Bratio_uncertainty.png}
