...
1,048.1-1,331.9 million eggs) (Figure~\ref{fig-es-so}). At the beginning
...
yield of 122 mt at SO40\% (95\% confidence interval: 108-137 mt). The
...
relative spawning output is relative to unfished spawning output.}
...
The model estimated uncertainty around the 2025 spawning output with a
