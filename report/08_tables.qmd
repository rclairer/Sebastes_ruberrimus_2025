...
source(here::here("Rcode/table_sens.R"))
age_comps_1 <- read.csv(here::here("report", "figures", "sensitivities", "age_comps_table_1.csv"))
...
source(here::here("Rcode/table_sens.R"))
age_comps_2 <- read.csv(here::here("report", "figures", "sensitivities", "age_comps_table_2.csv"))
