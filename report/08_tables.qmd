...
#| warning: false
#| results: "asis"
#| tbl-cap: "Base model sensitivity to the removal of data sources (compositional data)."
...
#names(comps) <-c("Label","Base","- CA TWL length comps","- CA NONTWL length comps","- CA REC length comps","- ORWA TWL length comps","- ORWA NONTWL length comps","- OR REC length comps","No length comps","- IPHC age comps","No age comps","McAllister & Ianelli")
