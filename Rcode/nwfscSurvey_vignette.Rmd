...
file.rename(from = file.path(getwd(), paste0("NWFSC.Combo_", length_files[1])),
            to = file.path(dirname(getwd()), "Data", "processed", "NWFSC.Combo_and_Tri_length_comps", paste0("NWFSC.Combo_", length_files[1])))
...
file.rename(from = file.path(getwd(), paste0("NWFSC.Combo_", length_files[2])),
            to = file.path(dirname(getwd()), "Data", "processed", "NWFSC.Combo_and_Tri_length_comps", paste0("NWFSC.Combo_", length_files[2])))
```
...
file.rename(from = file.path(getwd(), paste0("NWFSC.Combo_", age_files[1])), 
            to = file.path(dirname(getwd()), "Data", "processed", "NWFSC.Combo_age_comps", paste0("NWFSC.Combo_", age_files[1])))
...
file.rename(from = file.path(getwd(), paste0("NWFSC.Combo_", age_files[2])), 
          to = file.path(dirname(getwd()), "Data", "processed", "NWFSC.Combo_age_comps", paste0("NWFSC.Combo_", age_files[2])))
```
...
caal <- get_raw_caal(
  ...
  age_bins = 0:65,
  dir = file.path(dirname(getwd()), "Data", "processed", NWFSC.Combo_CAAL"),
  printfolder = "")
...
write.csv(one_sex_caal, file = file.path(dirname(getwd()), "Data", "processed", "NWFSC.Combo_CAAL", "processed_one_sex_caal.csv"), row.names = FALSE)
...
file.rename(from = file.path(getwd(), paste0("Tri_", length_files[1])),
            to = file.path(dirname(getwd()), "Data", "processed", "NWFSC.Combo_and_Tri_length_comps", paste0("Tri_", length_files[1])))

file.rename(from = length_files[2],
            to = paste0("Tri_", length_files[2]))
file.rename(from = file.path(getwd(), paste0("Tri_", length_files[2])),
            to = file.path(dirname(getwd()), "Data", "processed", "NWFSC.Combo_and_Tri_length_comps", paste0("Tri_", length_files[2])))
```
...
gemm_data <- pull_gemm("yelloweye rockfish", 
                       dir = file.path(dirname(getwd()), "Data", "processed"), 
                       verbose = TRUE)
