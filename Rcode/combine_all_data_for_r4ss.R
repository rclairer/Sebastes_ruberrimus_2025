...
file.copy(file.path(getwd(), "model", "2017_yelloweye_model_updated_ss3_exe", "yelloweye_data.ss"), 
...
all_lengths <- do.call("rbind", list(c(tri_lengths,
                                       nwfsc_lengths)))
