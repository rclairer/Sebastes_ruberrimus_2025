...
base_model_name <- "updated_alldata_tunecomps_fitbias_ctl_tunecomps_start_20250424"
```
...
# Next, specify the settings for running the profiles, within r4ss

# DON"T DO PROFILE IN PARALLEL...if there are convergence issues. 
# we dont have that problem so its okay to run in parallel
