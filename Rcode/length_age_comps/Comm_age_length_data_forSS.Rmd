...
```{r}
# length comps
dim(raw_length_comps_comb);dim(inputs$lencomp)
names(raw_length_comps_comb); names(inputs$lencomp)
names(raw_length_comps_comb) <- names(inputs$lencomp)

# caal
dim(raw_age_caal_comb);dim(inputs$agecomp)
names(raw_age_caal_comb); names(inputs$agecomp)
names(raw_age_caal_comb) <- names(inputs$agecomp)

# maal 
dim(raw_age_comps_comb);dim(inputs$agecomp)
names(raw_age_comps_comb); names(inputs$agecomp)
names(raw_age_comps_comb) <- names(inputs$agecomp)
```
