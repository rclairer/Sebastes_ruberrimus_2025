...
# OR_OBS
 # Dont need to do OR_OBS because I'm pretty sure they used "total samples" for Nsamps in 2017...but they were wrong...? ask Vlada

# Combine all data
all_data <- bind_rows(ca_df, or_df, wa_df, ca_obs_df)
